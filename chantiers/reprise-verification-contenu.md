...
> Prérequis : aucun. Le site du ministère refuse les sessions cloud : les textes intégraux
> sont fournis par Thibaud (`docs/sources-officielles.md`).
...
5. Le site du ministère refuse les sessions cloud : demande à Thibaud les textes intégraux
   dont tu as besoin (`docs/sources-officielles.md`) ; en attendant, travaille sur les
   extraits du rapport et dis-le dans chaque PR.
